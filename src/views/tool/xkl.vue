...
function init() {
  ...
  container = document.getElementById("xkl");
...
var Dragon = function() {
  ...
  this.mouth.rotation.x = 1; //Math.PI / 8;
...
Dragon.prototype.sneeze = function(a) {
  var s = a * 10;
  var _this = this,
    count = 10;
...
Dragon.prototype.backToNormal = function(a) {
  let s = 1000;
  var _this = this;
  var speed = 100 * globalSpeedRate;
  TweenLite.to(this.head.rotation, speed, {
    x: 1,
